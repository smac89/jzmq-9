...
public class TestUtils {
    ...
    /**
     * Remove a directory and delete all files and subdir recursively CAUTION: watchout with
     * symbolic links. not tested how the behaviour is but suspect this function will follow those
     * as well.
     *
